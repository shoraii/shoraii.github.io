...
(function () {
  ...
  var GOL = {
    ...
    colors : {
      ...
      {
        dead : '#0f111a',
        trail : ['#131521', '#161826', '#171928', '#191B2B', '#1B1D2D', '#1D1F30', '#1D2133', '#1F2133', '#222438', '#23263A', '#25283D', '#262A3F', '#2B3047', '#30354F', '#343A56', '#39405E'],
        alive : ['#41496B']
      }
    ...
    prepare : function() {
      ...
      this.element.generation.innerHTML = '';
      this.element.livecells.innerHTML = '';
      this.element.steptime.innerHTML = '';
    ...
    canvas: {
      ...
      init : function() {
        ...
        GOL.helpers.registerEvent(window, 'resize', GOL.handlers.resizeWindow, false);
        this.clearWorld();
      },
